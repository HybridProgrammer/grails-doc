Grails runs on any container that supports Servlet 3.1+ compatible container and above and is known to work on the following specific container products:
